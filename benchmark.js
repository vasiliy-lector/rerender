...
var suite = new Benchmark.Suite,
    { find, config, next, sequence, repeat, required, any, optional, deffered, end } = parser,
    createParser = function(cacheEnabled) {
        config('disableAutoCache', !cacheEnabled);
    ...
    noCacheRoot = createParser(false),
    rootWithCache = createParser(true),
